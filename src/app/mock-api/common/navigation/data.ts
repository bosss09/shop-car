...
export const defaultNavigation: FortNavigationItem[] = [
  {
    id      : 'dashboards',
    title   : 'Dashboards',
  ...
  },
  {
    ...
    children: [
      ...
      {
        id   : 'user-interface.fort-components',
        title: 'Fort Components',
        type : 'basic',
        icon : 'heroicons_outline:square-3-stack-3d',
        link : '/ui/fort-components',
      },
      {
  ...
  },
  {
    id      : 'documentation',
    title   : 'Documentation',
    subtitle: 'Everything you need to know about Fort',
    type    : 'group',
    icon    : 'heroicons_outline:information-circle',
    children: [
      {
...
export const compactNavigation: FortNavigationItem[] = [
  {
    id      : 'dashboards',
    title   : 'Dashboards',
    tooltip : 'Dashboards',
...
export const futuristicNavigation: FortNavigationItem[] = [
  {
    id      : 'dashboards',
    title   : 'DASHBOARDS',
    type    : 'group',
...
export const horizontalNavigation: FortNavigationItem[] = [
  {
    id      : 'dashboards',
    title   : 'Dashboards',
    type    : 'group',
