...
import { FortMockApiService, FortMockApiUtils } from '@fortmesh/lib/mock-api';
...
export class MessagesMockApi
{
   ...
   * Constructor
   */
  constructor(private _fuseMockApiService: FortMockApiService)
  {
  ...
  registerHandlers(): void
  {
    ...
    this._fuseMockApiService
      ...
      .reply(({request}) =>
      {
        ...
        // Generate a new GUID
        newMessage.id = FortMockApiUtils.guid();
